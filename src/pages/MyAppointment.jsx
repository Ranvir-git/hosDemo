        ...
        {doctors.slice(0,3).map((item, index)=>(
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
              ...
              <div className='flex-1 text-sm text-zinc-600'>
                ...
                <p className='text-x5'>{item.address.line}</p>
                <p className='text-xs mt-1'><spna className='text-sm text-neutral-700 font-medium'>Date & Time: </spna> 25, july, 2024 | 8:30 PM</p>
              </div>
              <div></div>
